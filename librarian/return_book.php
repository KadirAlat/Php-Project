                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <select name="enr" class="form-control">
                                                   ...
                                                   $res = mysqli_query($conn, "select student_enrollment from issue_books where books_return_date=0");
                                            ...
                                            <td>
                                                ...
                                                <input type="submit" name="submit1" value="Search" class="form-control" style="background-color: #ADB2B5 ;color:brown; font-size: 15px;">
                                            </td>
                                ...
                                if(isset($_POST["submit1"]))
                                {
                                    ...
                                    echo "<th>"; echo "Student E-mail"; echo "</th>";
                                    ...
                                    while($row=  mysqli_fetch_array($res))
                                                   {
                                                      echo "<tr>";
                                                       ...
                                                       echo "<td>"; ?> <a href="return.php?id=<?php echo $row["id"];?>"> Return Books<?php echo "</td>";
